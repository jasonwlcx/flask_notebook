...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_user_status(self):
        ...
        with self.client:
            ...
            self.assertTrue(data['data']['username'] == 'glaven')
            self.assertTrue(data['data']['email'] == 'glaven@mini-super.com')
